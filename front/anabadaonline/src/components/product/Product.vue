<template>
    <form @submit.prevent="productRegister" class="form">
        ...
        <div class="nameText rectangle-23" id="name">
            <input v-model="name" type="text" placeholder="상품명을 입력해주세요" style="border: none; outline: none" />
        </div>
        ...
        <div class="rectangle-233">
            <textarea class="form-control" id="detail" placeholder="상품 설명을 입력하세요" rows="7" cols="50"
                style="border: none; outline: none"></textarea>
        </div>
        <div class="usingDate commonText">
            상품 사용기간 <br>
        </div>
        ...
        <div class="radioSelect">
            <input type="radio" id="one" value="미사용" v-model="picked" checked />
