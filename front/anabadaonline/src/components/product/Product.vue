<template>
    <form @submit.prevent="productRegister" class="form">
        ...
        <div class="nameText rectangle-23" id="name">
            <input class="textSize" v-model="name" type="text" placeholder="상품명을 입력해주세요"
                style="border: none; outline: none" />
        </div>

        <div class="commonText">경매 시작 가격</div>
        <div class="priceText" id="price">
            <input class="textSize" v-model="price" type="text" placeholder="경매 시작 가격을 입력해주세요( , 없이 숫자만 입력)"
                style="border: none; outline: none" />
        </div>
        ...
        <div class="rectangle-233">
            <textarea class="form-control" id="detail" placeholder="상품 설명을 입력하세요" v-model="detail" rows="7" cols="50"
